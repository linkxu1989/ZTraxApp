...
namespace ZTraxApp.UserControls
{
    ...
    public partial class Stopwatch : UserControl
    {
        ...
        string ElapsedTimeString
        {
            get
            {
                return TimeSpanToString(DisplayTotalTime ?
                                        TotalTimeElapsed :
                                        _stopwatch.Elapsed);
            }
        }

        static class TimeFormats
        {
            public const string Default = @"hh\:mm\:ss\.fff";
            public const string Long = @"d\.hh\:mm\:ss\.fff";
        }
        ...
        private void StartStopButton_Click(object sender, RoutedEventArgs e)
        {
            if (!IsRunning)
            {
                ...
                _textBoxTimer.Start();
                //ButtonStartStop.Background = System.Windows.Media.Brushes.Red;
            ...
            else
            {
                ...
                //ButtonStartStop.Background = System.Windows.Media.Brushes.White;
