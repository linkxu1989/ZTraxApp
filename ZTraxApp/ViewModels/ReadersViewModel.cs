...
namespace ZTraxApp.ViewModels
{
    public class ReadersViewModel : INotifyPropertyChanged
    {
        ...
        ReaderService ObjReaderservice;
        public ReadersViewModel()
        {
            ObjReaderservice = new ReaderService();
            LoadData();
            CurrentReaders = new Readers();
        ...
        private ObservableCollection<Readers> readersList;
        ...
        private async void LoadData()
        {
            await Task.Run(() =>
            {
                ...
                ReadersList = new ObservableCollection<Readers>(ObjReaderservice.GetAll());
                Visibility = Visibility.Hidden;
            });
        }
        #endregion

        private Readers currentReaders;
        public Readers CurrentReaders
        {
            get { return currentReaders; }
            set { currentReaders = value; OnPropertyChanged("CurrentReaders"); }
        }
